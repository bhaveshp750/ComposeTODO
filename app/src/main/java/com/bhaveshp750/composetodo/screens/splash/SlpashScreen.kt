...
import com.bhaveshp750.composetodo.common.composable.BasicButton
...
fun SplashScreen(
  ...
  Column(
    ...
    if (viewModel.showError.value) {
      ...
      BasicButton(AppText.try_again, modifier = Modifier.basicButton()) { viewModel.onAppStart(openAndPopUp) }
    } else {
